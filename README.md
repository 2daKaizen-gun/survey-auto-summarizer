...
| 2 | Participation Status | Whether the student attended the last event |
| 3 | Name / Student ID | Personal identification |
| 4 | Gender / Nationality | Demographic data for cross-analysis |
| 5 | **Feedback (100+ chars)** | **Primary source for AI text analysis** |
| 6 | **AI Aggregate Insights** | **Final output written by Gemini API** |
